...
@protocol YFPlusButtonSubclassing
...
+ (CGFloat)multiplerInCenterY RT_DEPRECATED("Deprecated in 1.6.0. Use `+multiplierOfTabBarHeight:` instead.");

@end

@class YFTabBar;

FOUNDATION_EXTERN UIButton<YFPlusButtonSubclassing> *YFExternPlusButton;
FOUNDATION_EXTERN UIViewController *YFPlusChildViewController;

@interface YFPlusButton : UIButton
...
@interface YFPlusButton (YFDeprecated)

+ (void)registerSubclass RT_DEPRECATED("Deprecated in 1.6.0. Use `+[CYLPlusButton registerPlusButton]` instead.");
